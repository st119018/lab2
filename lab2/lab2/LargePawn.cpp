...
LargePawn::LargePawn(int Ind1, int Ind2, int Ind3, int Ind4, int Ind5, int Ind6, int Ind7, int Ind8)
{
    Pawn1 = Ind1;
    Pawn2 = Ind2;
    Pawn3 = Ind3;
...
bool LargePawn::isPossibleForLargePawn(int prevInd, int nextInd, int mapWidth, char* map)
{
    if (prevInd == Pawn1 || prevInd == Pawn2 || prevInd == Pawn3 || prevInd == Pawn4 ||
        ...
        else if (nextX == prevX && nextY == prevY - 2 && prevY == 7 &&
